    ...
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddDbContext<ApplicationDbContext>(
                option => option.UseSqlServer(builder.Configuration.GetConnectionString("TF")
                ));
            ...
            builder.Services.AddHangfire(config => config
                               ...
                               .UseSqlServerStorage(builder.Configuration.GetConnectionString("TF"), new SqlServerStorageOptions
                               {
